...
function Preprocess() {
  ...
  const [clickCount, setClickCount] = useState(0); // State to count button clicks
    ...
    <div>
      ...
      <div className="preprocess">
        <form onSubmit={handleSubmit} className="image-form">
          ...
          <button type="submit" disabled={loading || clickCount >= 2} id='newbut'>
...
function Preprocess() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      fetchChatGPTResponse(); // Fetch the ChatGPT response after successful submission
    } catch (error) {
